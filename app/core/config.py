...
if cors_env and not cors_env.startswith("["):
    ...
    if "https://nexora-meet-b4aa.vercel.app" not in origins:
        origins.append("https://nexora-meet-b4aa.vercel.app")
...
class Settings(BaseSettings):
    ...
    EMAIL_TEST_MODE: bool = os.getenv("EMAIL_TEST_MODE", "false").lower() in ("true", "1", "yes")
