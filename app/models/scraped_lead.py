...
class ScrapedLead(Base):
    ...
    reply_status: Mapped[str] = mapped_column(String(50), default="unprocessed", server_default="unprocessed", index=True) # unprocessed, classified, replied, etc.
    unsubscribe: Mapped[bool] = mapped_column(Boolean, default=False, server_default="0", index=True)
    bounced: Mapped[bool] = mapped_column(Boolean, default=False, server_default="0", index=True)
